...
-- =============================================
CREATE PROCEDURE [dbo].[GenerateDimDate]
AS
BEGIN
...
--		[DayOfWeekInMonth] TINYINT, --1st Monday or 2nd Monday in Month
--		[DayOfWeekInYear] SMALLINT,
--		[DayOfQuarter] SMALLINT,
--		[DayOfYear] SMALLINT,
--		[WeekOfMonth] SMALLINT,-- Week Number of Month 
--		[WeekOfQuarter] SMALLINT, --Week Number of the Quarter
--		[WeekOfYear] SMALLINT,--Week Number of the Year
--		[Month] TINYINT, --Number of the Month 1 to 12
--		[MonthName] VARCHAR(9),--January, February etc
--		[MonthOfQuarter] VARCHAR(2),-- Month Number belongs to Quarter
--		[Quarter] TINYINT,
--		[QuarterName] VARCHAR(9),--First,Second..
--		[Year] SMALLINT,-- Year value of Date stored in Row
...
VALUES  ( -1 , -- DateKey - int
          '1/1/1990' , -- Date - datetime
          '1/1/1990' , -- FullDateUK - char(10)
          '1/1/1990' , -- FullDateUSA - char(10)
          0 , -- DayOfMonth - tinyint
          'NA' , -- DaySuffix - varchar(4)
          'NA' , -- DayName - varchar(9)
          '0' , -- DayOfWeekUSA - char(1)
          '0' , -- DayOfWeekUK - char(1)
          0 , -- DayOfWeekInMonth - tinyint
          0 , -- DayOfWeekInYear - smallint
          0 , -- DayOfQuarter - smallint
          0 , -- DayOfYear - smallint
          0 , -- WeekOfMonth - smallint
          0 , -- WeekOfQuarter - smallint
          0 , -- WeekOfYear - smallint
          0 , -- Month - tinyint
          'NA' , -- MonthName - varchar(9)
          'NA' , -- MonthOfQuarter - varchar(2)
          0 , -- Quarter - tinyint
          'NA' , -- QuarterName - varchar(9)
          0 , -- Year - smallint
          'NA' , -- YearName - char(7)
          'NA' , -- MonthYear - char(10)
          'NA' , -- MMYYYY - char(6)
          '1/1/1990' , -- FirstDayOfMonth - date
           '1/1/1990' , -- LastDayOfMonth - date
           '1/1/1990' , -- FirstDayOfQuarter - date
           '1/1/1990' , -- LastDayOfQuarter - date
           '1/1/1990' , -- FirstDayOfYear - date
           '1/1/1990' , -- LastDayOfYear - date
          0 , -- IsHolidayUSA - bit
          0 , -- IsWeekday - bit
          'NA' , -- HolidayUSA - varchar(50)
          0 , -- IsHolidayUK - bit
          'NA'  -- HolidayUK - varchar(50)
        )
